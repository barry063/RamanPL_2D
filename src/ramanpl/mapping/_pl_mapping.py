...
from ramanpl.visualisation._mapping import (
    plot_pl_heatmap as _plot_pl_heatmap,
    plot_pl_residual_distribution as _plot_pl_residual_distribution,
    plot_pl_spectrum_fit as _plot_pl_spectrum_fit,
)
...
class PLMapping(_MappingPreprocessMixin):
    ...
    def plot_spectrum_fit(self, x, y):
        return _plot_pl_spectrum_fit(self, x, y)
    ...
    def plot_residual_distribution(
        ...
        return _plot_pl_residual_distribution(
            self,
    ...
    def plot_heatmap(self, data_type='exciton_position', cmap='viridis',
        ...
        return _plot_pl_heatmap(
            self,
            data_type=data_type,
            cmap=cmap,
            filter_range=filter_range,
            specific_xdata=specific_xdata,
            x_range=x_range,
            y_range=y_range,
        )
