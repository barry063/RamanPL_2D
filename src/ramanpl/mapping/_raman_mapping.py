...
from ramanpl.visualisation._mapping import (
    plot_raman_heatmap as _plot_raman_heatmap,
    plot_raman_ratio_heatmap as _plot_raman_ratio_heatmap,
    plot_raman_residual_distribution as _plot_raman_residual_distribution,
    plot_raman_spectrum_fit as _plot_raman_spectrum_fit,
)
...
class RamanMapping(_MappingPreprocessMixin):
    ...
    def plot_spectrum_fit(self, x, y):
        return _plot_raman_spectrum_fit(self, x, y)
    ...
    def plot_residual_distribution(
        ...
        return _plot_raman_residual_distribution(
            self,
    ...
    def plot_ratio_heatmap(self, ratio_type='A1g/E2g', cmap='viridis', filter_range=None, x_range=None, y_range=None):
        return _plot_raman_ratio_heatmap(
            self,
    ...
    def plot_heatmap(self, data_type='position', cmap='viridis', filter_range=None, 
        ...
        return _plot_raman_heatmap(
            ...
            x_range=x_range,
            y_range=y_range,
            specific_wavenumber=specific_wavenumber,
            peak_name=peak_name,
        )
